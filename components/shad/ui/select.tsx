...
>(({ className, children, ...props }, ref) => (
  <div className="border border-slate-200 dark:border-slate-800 rounded-md w-fit">
    <SelectPrimitive.Trigger
      ref={ref}
      className={cn(
        'flex h-10 w-full items-center justify-between bg-white px-3  text-sm ring-offset-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-slate-950 focus:ring-offset-2 rounded-md disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1  dark:bg-slate-950 dark:ring-offset-slate-950 dark:placeholder:text-slate-400 dark:focus:ring-slate-300',
        className
      )}
      {...props}
    >
